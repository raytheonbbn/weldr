...
void * reader_1(void * arg)
{
    ...
    // Read from resource
    printf(">>> updated counter, reader_1() = %d\n", counter);
...
void * writer_1(void * arg)
{
    ...
    ACCESS_ONCE(counter)++;
    printf("*** updated counter, writer_1() = %d\n", counter);
...
void * reader_2(void * arg)
{
    ...
    // TODO do a READ here
    printf(">>> updated counter, reader_2() = %d\n", counter);

    // Set wait condition
    //printf("Wating for cond_3 ....\n");
...
/*void * cond_3_release(void * arg)
{
    // Signal that mutex_3 can unlock
    printf("Signaling for cond_3 to resolve\n");
...
int main(int argc, char *argv[])
{
    ...
    if(pthread_create(&tid1, NULL, reader_1, &rwlock) != 0) {
    ...
    if(pthread_create(&tid4, NULL, reader_2, &rwlock) != 0) {
        perror("pthread_create error");
        return 1;
    }
    ...
    /*sleep(3);
    if(pthread_create(&tid6, NULL, cond_3_release, &rwlock) != 0) {
        perror("pthread_create error");
        return 1;
        }*/
