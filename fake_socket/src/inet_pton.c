...
/*
 * Weldr: I literally copied this out of glibc; it's way easier
 * to include statically and have the symbols override the dynamic
 * imports than it is to model these in symbolic analysis.
 */
